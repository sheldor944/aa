           ...
           //   printf("u::%d p::%d  gas::%d jacce::%d ase::%d\n",u,p,g,dis[u][g+1],dis[u][g]);
              ...
              for(i=0;i<sz;++i)
              {
                     ...
                     d=adj[u][i].second;
                        ...
                        if(d>g){
                            cout<< " here d > g for u to v "<<d<<" > " <<g<<" and "<< u << " to " << v << " and d is "<<d<<endl;
                        continue;
                        }       
                 if(dis[v][g-d]>dis[u][g])
                     {      
                            cout<<" dis v g-d is "<<dis[v][g-d]<<" g and  d is  "<< g<<" " <<d<<" "<<" and dis u g is "<<dis[u][g]<<endl;
